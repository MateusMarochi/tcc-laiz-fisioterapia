...
\newcommand{\utfprCabecalho}{%
    \fancyhf{}
    \fancyhead[L]{\includegraphics[height=2.0cm]{assets/imagens/unidep.png}}
    \fancyhead[R]{\includegraphics[height=2.0cm]{assets/imagens/coppex.png}}
    \fancyfoot[C]{\thepage}
...
\fancypagestyle{plain}{\utfprCabecalho}
\fancypagestyle{plainheader}{\utfprCabecalho}
...
(\xmark) Autorizo a disponibilização do seguinte correio eletrônico para contato: laizcamilifacul@gmail.com}
\licencaCCBY{}
\licencaCCBYNC{}
\licencaCCBYNCND{X}
\licencaCCBYNCSA{}
...
\autor{Laiz Camili Ferreira Olenik}
\cita{OLENIK, Laiz Camili F.}
...
\begin{dedicatoria}
\vspace*{\fill}
Dedico este trabalho a Deus e a minha família, em reconhecimento ao apoio em cada etapa desta jornada acedêmica.\\[1ex]
\vspace*{\fill}
\end{dedicatoria}

\begin{agradecimentos}
Agradeço a Prof.ª Me. Thais Feihrmann, pela orientação, bem como à parturiente Larissa e a doula que se dispuseram a contribuir com este estudo, tornando-o possível.
\end{agradecimentos}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/imagens/IMG_0753.JPG}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/imagens/IMG_0754.JPG}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/imagens/IMG_0755.JPG}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/imagens/IMG_0756.JPG}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/imagens/IMG_0757.JPG}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/imagens/IMG_0758.JPG}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/imagens/IMG_0759.JPG}
    \caption{Aplicação das técnicas respiratórias durante o trabalho de parto.}
    \label{fig:trabalho-parto}
\end{figure}

A manutenção da respiração ritmada e do suporte contínuo ao longo das contrações intensas está representada nas Figuras~\ref{fig:trabalho-parto-dinamica} e~\ref{fig:trabalho-parto-companheiro}, que evidenciam a participação ativa da equipe e do acompanhante.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/imagens/IMG_0760.JPG}
    \caption{Organização postural e respiratória durante o trabalho de parto.}
    \label{fig:trabalho-parto-dinamica}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/imagens/IMG_0761.JPG}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/imagens/IMG_0762.JPG}
    \caption{Parturiente em preparo para cesariana após tentativa de parto vaginal.}
